---
{
  ...
  "editorial_notes": [
    ...
    "This chapter's running header uses an en dash ('CHAPTER 6 – U.S. GEOGRAPHY') rather than the colon Chapters 1–5 used; the coverage test's banner filter was broadened to accept any separator rather than special-cased for this chapter."
  ]
}
---
<!-- page:38 -->
