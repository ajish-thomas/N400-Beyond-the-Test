---
{
  ...
  "objectives": ["The Legislative Branch of the U.S. government.", "The House of Representatives.", "The Senate.", "The process for making federal laws."],
  "questions": [18,19,20,21,22,23,24,25,27,28,29,30,31,33,34,35,41,43,44,64],
  "images": ["ch02-oval-office"],
  "source_start": 18,
  "source_end": 23,
  "editorial_notes": [
    "This text edition preserves the prose, objectives, sidebar, diagram and map labels, and captions. Map geography and uncredited illustrations are not reproduced. The credited Oval Office photograph is included. Page 23 contains no chapter content.",
    "The page 22 lawmaking diagram has no extractable text in the PDF. Its labels were transcribed from the rendered page and checked separately. The prose describes a congressional veto override, while the simplified diagram does not; both are retained as printed.",
    "The line-break hyphen in ‘representa-tives’ on page 18 is joined to form ‘representatives’. The California and Wyoming examples, vote counts, and eligibility descriptions are reproduced from this 2025 textbook without supplementation."
  ]
}
---
<!-- page:18 -->
...
Two Parts
├─ U.S. House of Representatives
│  ├─ 435 U.S. Representatives in the House of Representatives
│  ├─ The number of representatives for a state depends on the number of people that live there
│  ├─ Represent a district
│  └─ 2-year terms for U.S. Representatives
└─ U.S. Senate
   ├─ 100 U.S. Senators in the U.S. Senate
   ├─ Each state has two senators
   ├─ Represent all of the people of a state
   └─ 6-year terms for U.S. Senators
```
...
A bill starts with an idea that people want to become a law
↓
Congress writes a bill
↓
House of Representatives
NO / YES
A majority of the 435 voting members approve
↓
Senate
NO / YES
A majority of the 100 voting members approve
...
![The Oval Office of the White House. Photo by Cecil Stoughton.](ch02-oval-office)
