...
func (c *Catalog) validate(files fs.FS) error {
	...
	for i := range c.Images {
		...
		if img.Credit != "Courtesy of the Library of Congress." && img.Credit != "Courtesy of the National Archives." && img.Credit != "Courtesy of the John F. Kennedy Presidential Library and Museum." && img.Credit != "Courtesy of the National Park Service." && img.Credit != "Courtesy of the U.S. Geological Survey." && img.Credit != "Courtesy of the U.S. Senate." {
